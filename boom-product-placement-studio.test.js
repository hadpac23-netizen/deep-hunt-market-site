...
assert(readiness.areas.some(x=>x.id==="product_placement_gate"&&x.status==="CODED_SHADOW_ALWAYS_ON_STUDIO_STAGE4"));
...
console.log("BOOM Studio Stage 4 queue surface: PASS");
