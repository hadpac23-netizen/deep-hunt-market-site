(() => {
  ...
  function buildConnectRows(){
    ...
    return [
      ...
      {id:"posthog",name:"PostHog EU",kind:"ANALYTICS + EVIDENCE",tone:"healthy",detail:"Product Analytics and canonical Web Analytics $pageview ingestion are verified in BOOM Studio EU. Session Replay and Error Tracking are enabled in the project; replay/exception evidence remains observation-based and must not be claimed until events are seen.",evidence:"Product + $pageview VERIFIED · Replay/Error ENABLED · evidence pending",gate:"Owner gate for project/token or privacy-policy changes"},
