(() => {
  ...
  function buildConnectRows(){
    ...
    return [
      ...
      {id:"posthog",name:"PostHog EU",kind:"ANALYTICS + EVIDENCE",tone:"watch",detail:"Product Analytics ingestion is verified in the BOOM Studio EU project. Web Analytics canonical $pageview is not yet observed; Session Replay and Error Tracking are not enabled in the project yet.",evidence:"Product Analytics VERIFIED · Web/Replay/Error WATCH",gate:"Owner gate for project/token or privacy-policy changes"},
