(() => {
  ...
  function buildConnectRows(){
    ...
    return [
      ...
      {id:"posthog",name:"PostHog EU",kind:"ANALYTICS + EVIDENCE",tone:"healthy",detail:"HUNT web installation is verified against the BOOM Studio EU project and live ingestion accepted a real verification event.",evidence:"EU install verified · 2026-09-17",gate:"Owner gate for project/token or privacy-policy changes"},
