...
CANDS=[
 ...
 {"department":"men","category":"home-slippers","product_id":"31422894","supplier_category_id":63},
 ...
 {"department":"home","category":"lighting","product_id":"29509210","supplier_category_id":109},
 {"department":"home","category":"digital-clock","product_id":"28638952","supplier_category_id":110},
]
...
def signed_get(path,params):
 ...
 req=urllib.request.Request(BASE+path+"?"+urllib.parse.urlencode(q),headers={"apiKey":key,"Accept":"application/json","User-Agent":"HUNT-WAVE3A-PROGRESS/1.0"})
  ...
  for cost,w,ns,vid,v in variants[:6]:
   try:
    ...
    if st==200 and str(b.get("code"))=="0" and sh:
     pg=retail(cost); ratio=round(sh["cost_usd"]/pg["retail_usd"],3)
...
out={"version":"HUNT-EPROLO-WAVE3A-IL-SCAN-V1","date":"2026-09-22","mode":"READ_ONLY_SHADOW","destination":"IL","production_effect":False,"summary":summary,"results":results}
(ROOT/"evidence/HUNT-EPROLO-WAVE3A-IL-SCAN-2026-09-22.json").write_text(json.dumps(out,ensure_ascii=False,indent=2)+"\n")
