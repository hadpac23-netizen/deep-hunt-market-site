...
assert(read("product.html").indexOf("hunt-product-qa.js?v=1")<read("product.html").indexOf("product.js?v=launchqa7"),"Product Q&A listener must load before product state publisher");
