...
assert.equal(c.current_state.full_shelves_unique_products,5182);
assert.equal(c.current_state.full_shelves_initial_cards,1679);
...
assert.equal(c.current_state.cj_verified_4_market_products,39);
assert.equal(c.current_state.verified_truth_products_available,54);
...
assert.equal(academy.current_state.full_shelves_unique_products,5182);
assert.equal(academy.current_state.full_shelves_taxonomy_discipline,"PASS_NO_CROSS_DEPARTMENT_DUPLICATION");
assert.equal(academy.current_state.cj_verified_4_market_products,39);
