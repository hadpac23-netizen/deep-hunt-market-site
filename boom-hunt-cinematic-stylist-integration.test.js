...
assert.equal(c.version,"BOOM-HUNT-CINEMATIC-STYLIST-INTEGRATION-V3");
...
assert.equal(c.current_state.full_shelves_shadow_preview,"PASS_17_DEPARTMENTS");
assert.equal(c.current_state.full_shelves_category_rails,95);
assert.equal(c.current_state.full_shelves_unique_products,5143);
assert.equal(c.current_state.full_shelves_initial_cards,1640);
...
assert.equal(academy.current_state.full_shelves_shadow_preview,"PASS_17_DEPARTMENTS_95_CATEGORY_RAILS");
assert.equal(academy.current_state.full_shelves_unique_products,5143);
