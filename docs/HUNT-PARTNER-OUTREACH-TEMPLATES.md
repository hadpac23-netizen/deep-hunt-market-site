# HUNT Partner Outreach Templates
...
- tracked outbound commerce for approved partner stores
- product reviews, likes, saves and user shopping profiles
- country/language-aware merchandising

Do not claim traffic, conversion volume, revenue, user count, purchase volume or geographic reach unless measured and current.
...
Our current platform supports:
- product-feed/API ingestion
- category and product-level discovery
- personalized product ranking
- tracked outbound clicks and partner attribution
- saved products, likes and shopper profiles
- merchant onboarding and product moderation

We would like to explore joining THE OUTNET affiliate program and, if approved, integrating your product feed into HUNT’s fashion and outlet discovery experience.
...
The goal would be to surface relevant YOOX products inside HUNT and direct qualified shoppers to YOOX through approved affiliate links.
...
We would like to apply through the most suitable iHerb affiliate network and explore product/catalog access for a compliant HUNT integration.
...
1. Confirm the official program is still open.
2. Confirm the HUNT public site loads correctly.
3. Confirm there are no fake products, prices, reviews or user-count claims.
4. Confirm the partner is added to hunt_partner_leads.
5. Set status to contacted only after the actual message is sent.
6. Record contact channel/date and next action.
