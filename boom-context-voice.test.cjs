...
for(const ping of ["ילה","בווום","היי בום","לא הבנתי","איפה זה עומד עכשיו","תן לי קופי","כן","מאשר","yes","אשר Final Learning Production.","approve final learning production"]){
