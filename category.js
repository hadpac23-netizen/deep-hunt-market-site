(() => {
  ...
  const curatedFashionSlugs = new Set(["women","men","dresses","jeans","tops","bottoms","hoodies","jackets","knitwear","activewear","suits","underwear","womenunderwear","menunderwear","kidsunderwear","sleepwear","loungewear","plussize","petite","maternity","sets","socks","swimwear","shoes","slippers","bags","jewelry","accessories","hats"]);
  const curatedFocusSlugs = new Set(["beauty","makeup","skincare","haircare","bodycare","gaming","tech","lighting","travel","crafts","sports","fitnessequipment","yoga","runningcycling","swimming","ballsports","racketsports","sportstowels","towels","sunglasses","drinkware","bedding","hats","socks","swimwear","pets","petbeds","catfurniture","petfeeders","pettoys","petgrooming","pettravel"]);
