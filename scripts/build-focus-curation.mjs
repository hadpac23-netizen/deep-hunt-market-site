...
const tests={
  ...
  sports:t=>/\b(yoga mat|resistance bands?|fitness bands?|dumbbells?|jump rope|skipping rope|running belt|gym bag|exercise mat|workout bands?)\b/i.test(t)
    &&!/\b(dog|pet|therapy|medical)\b/i.test(t),
